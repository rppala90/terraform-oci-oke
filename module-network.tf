...
module "vcn" {
  ...
  create_internet_gateway = alltrue([
    ...
    anytrue([                                             # enable for configurations that generally utilize it
      ...
      var.create_bastion && var.bastion_type == "public", # enable for public bastion
      var.control_plane_type == "public",                 # enable for cluster w/ public endpoint
  ...
  create_nat_gateway = alltrue([
    ...
    anytrue([                                             # enable for configurations that generally utilize it
      ...
      var.worker_type == "private",                       # enable for private workers
      var.create_operator,                                # enable for operator
      var.control_plane_type != "public",                 # enable for cluster w/ private endpoint
